...
\newcommand\mn[2][0pt]{%
  ...
  \marginpar{\hbox{}\vspace*{-\the\margindifference}\vspace*{-1.739\baselineskip}\vspace{#1}\singlespacing\footnotesize#2}} % the 1.739 comes from 2/1.15, where 1.15 is the main body's line spacing
#+END_SRC
